...
import { Users, Lightbulb, Mail, Wrench, Smartphone, History, Target, Award, Heart, Zap, TrendingUp } from "lucide-react";
        ...
        <div>
            <section className="py-20 px-4">
                <div className="container mx-auto text-center max-w-4xl">
                    <Badge variant="secondary" className="mb-6 px-4 py-2 dark:bg-slate-700 dark:text-gray-300">
                        ...
                        <div>
                            ...
                            <div className="space-y-4 dark:text-gray-300 text-gray-600 text-lg leading-relaxed">
                                ...
                                <p>
                                    ...
                                    <span className="font-semibold dark:text-blue-400 text-blue-600">Android Praktikums</span>, unter der Betreuung von Nils
                ...
                <div className="container mx-auto max-w-6xl">
                    ...
                    <div className="bg-gradient-to-r dark:from-blue-900 dark:to-indigo-900 from-blue-50 to-indigo-50 rounded-2xl p-8">
                        <p className="text-lg dark:text-gray-300 text-gray-600 leading-relaxed text-center max-w-4xl mx-auto">
                            Heute ist die App mit über 20.000 aktiven Nutzern eine der erfolgreichsten Apps, die an deutschen Universitäten angeboten werden.
                            Viele weitere Ideen sind mittlerweile teil von TUM-Dev. Im regen Austausch entwickeln wir neue Features für die digitale Universität
                            der Zukunft.
                        </p>
                    </div>
                </div>
                ...
                <div className="container mx-auto max-w-6xl text-center">
                    <div className="bg-gradient-to-r dark:from-blue-900 dark:to-indigo-900 from-blue-50 to-indigo-50 rounded-2xl p-12">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <Button size="lg" variant="outline" className="dark:border-slate-600 dark:text-gray-300 dark:hover:bg-slate-700">
