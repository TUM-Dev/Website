...
import { Calendar, CalendarIcon, Clock, Code, Github, Lightbulb, Mail, MapPin, Users, Users2 } from "lucide-react";
                ...
                <div className="container mx-auto max-w-6xl">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {projects.map((project) => (
                            <Project description={project.description} key={project.name} name={project.name} tech={project.tech} />
                        ))}
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 px-4 bg-gradient-to-r dark:from-blue-800 dark:to-blue-900 from-blue-500 to-blue-600" id="cta">
                <div className="container mx-auto text-center max-w-4xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Button className="border-white text-slate-900 hover:bg-white/10" size="lg" variant="outline">
                            <Users className="w-5 h-5 mr-2" />
                            Zu unseren Treffen
                        </Button>
                    </div>
