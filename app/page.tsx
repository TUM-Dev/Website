...
import { Code, Users, Calendar, Lightbulb, Github, Mail, MapPin, Clock, CalendarIcon, Users2, Wrench, Trophy, Coffee } from "lucide-react";
    ...
    const slideshow: readonly SlideShowItem[] = [
        {
            ...
            caption: "Einmal im monat machen wir ein Team Meeting, wo wir Ideen/Probleme besprechen und unseren Fortschritt präsentieren",
        },
        //{
        ...
        },
        {
            ...
            caption: "Hin und wieder machen wir LiveStreaming für andere Hochschulgruppen - Hier beispielsweise für den BayStuRa",
        },
        {
            src: "/events/fossgis25.png",
            alt: "Team auf einer Konferenz",
            caption: "Gemeinsam auf einer Open Source Konferenz - Networking und neue Ideen",
        },
        {
        ...
        },
        {
            ...
            caption: "TUM-Präsentationen - Hin und wieder präsentieren wir IT-Projekte. Hier beispielsweise mit unserem CIO beim iPraktikum",
        },
        {
            src: "/events/student-club-fair24.jpg",
            alt: "Projekt Präsentation",
            caption: "Projekt-Präsentationen - Wir präsentieren regelmäßig unsere projekte bei diversen veranstaltungen. Hier die StudentClub Fair",
        },
        {
        ...
        },
        {
            ...
            caption: "Neben code machen wir auch Veranstaltungen - hier haben wir beispielsweise die Photobox für die Unity gebaut",
        },
    ];
    ...
    return (
        <div>
            <section className="py-20 px-4">
                <div className="container mx-auto text-center max-w-4xl">
                    <Link href="https://www.sv.tum.de/sv/hochschulgruppen/">
                        <Badge variant="secondary" className="mb-6 px-4 py-2 dark:bg-slate-700 dark:text-gray-300 dark:hover:text-gray-900">
                    ...
                    <p className="text-xl dark:text-gray-300 text-gray-600 mb-8 leading-relaxed max-w-3xl mx-auto">
                        Wir arbeiten an verschiedenen Open Source Projekten, organisieren Veranstaltungen und bieten Workshops an.
                    </p>
            ...
            >
                <div className="container mx-auto max-w-6xl">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold dark:text-white text-gray-900 mb-4">Was wir machen</h2>
                        <p className="dark:text-gray-300 text-gray-600 max-w-2xl mx-auto">
                            Unsere Projekte sind für alle frei verfügbar und wir freuen uns über jede Unterstützung.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow dark:bg-slate-700 dark:border-slate-600 bg-white">
                            <CardHeader>
                                ...
                                <CardTitle className="dark:text-white text-gray-900">Software Entwicklung</CardTitle>
                                <CardDescription className="dark:text-gray-300 text-gray-600">
                                    Wir entwickeln innovative Open Source Software und tragen zu bestehenden Projekten bei.
                                </CardDescription>
                            </CardHeader>
                        </Card>
                        ...
                        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow dark:bg-slate-700 dark:border-slate-600 bg-white">
                            <CardHeader>
                                ...
                                <CardTitle className="dark:text-white text-gray-900">Veranstaltungen</CardTitle>
                                <CardDescription className="dark:text-gray-300 text-gray-600">
                                    Wir organisieren regelmäßige Events, Hackathons und Meetups für die Open Source Community.
                                </CardDescription>
                            </CardHeader>
                        </Card>
                        ...
                        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow dark:bg-slate-700 dark:border-slate-600 bg-white">
                            <CardHeader>
                                ...
                                <CardTitle className="dark:text-white text-gray-900">Workshops</CardTitle>
                                <CardDescription className="dark:text-gray-300 text-gray-600">
                                    Wir bieten Workshops zu verschiedenen Technologien und Open Source Tools an.
                                </CardDescription>
                            </CardHeader>
                        </Card>
                    </div>
            ...
            >
                <div className="container mx-auto max-w-6xl">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold dark:text-white text-gray-900 mb-4">Kommende Termine</h2>
                        <p className="dark:text-gray-300 text-gray-600">Verpasse keine unserer Veranstaltungen und Treffen</p>
                    </div>
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1">
                                            <h4 className="font-semibold dark:text-white text-gray-900 mb-2">Wöchentliches Treffen</h4>
                                            <p className="dark:text-gray-300 text-gray-600 mb-3">
                                                Jeden Donnerstag besprechen wir aktuelle Projekte und planen neue Initiativen.
                                            </p>
                                        ...
                                        <Badge className="bg-green-100 text-green-800">Regelmäßig</Badge>
                                    </div>
                                </CardContent>
                            </Card>
                        </div>
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-start justify-between mb-3">
                                        <div className="flex items-center">
                                            ...
                                            <div>
                                                <h4 className="font-semibold dark:text-white text-gray-900">Git & GitHub Workshop</h4>
                                                <p className="text-sm dark:text-gray-400 text-gray-500">15. Januar 2024</p>
                                            </div>
                                        </div>
                                    ...
                                    <p className="dark:text-gray-300 text-gray-600 text-sm mb-3">
                                        Lerne die Grundlagen von Git und GitHub für Open Source Projekte.
                                    </p>
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-start justify-between mb-3">
                                        <div className="flex items-center">
                                            ...
                                            <div>
                                                <h4 className="font-semibold dark:text-white text-gray-900">TUM Open Source Hackathon</h4>
                                                <p className="text-sm dark:text-gray-400 text-gray-500">22.-23. Januar 2024</p>
                                            </div>
                                        </div>
                                        <Badge variant="outline" className="dark:border-slate-600 dark:text-gray-300">
                                            Hackathon
                                    ...
                                    <p className="dark:text-gray-300 text-gray-600 text-sm mb-3">
                                        48h Hackathon mit Fokus auf studentische Open Source Projekte.
                                    </p>
                                    <div className="flex items-center text-sm dark:text-gray-400 text-gray-500">
                                        <Clock className="w-4 h-4 mr-1" />
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-start justify-between mb-3">
                                        <div className="flex items-center">
                                            ...
                                            <div>
                                                <h4 className="font-semibold dark:text-white text-gray-900">Open Source Coffee Chat</h4>
                                                <p className="text-sm dark:text-gray-400 text-gray-500">29. Januar 2024</p>
                                            </div>
                                        </div>
                                        <Badge variant="outline" className="dark:border-slate-600 dark:text-gray-300">
                                            Networking
                                    ...
                                    <p className="dark:text-gray-300 text-gray-600 text-sm mb-3">
                                        Lockeres Treffen zum Austausch über Open Source Trends und Projekte.
                                    </p>
                                    <div className="flex items-center text-sm dark:text-gray-400 text-gray-500">
                                        <Clock className="w-4 h-4 mr-1" />
                    ...
                    <div className="mt-12 text-center">
                        <div className="bg-gradient-to-r dark:from-blue-900 dark:to-indigo-900 from-blue-50 to-indigo-50 rounded-2xl p-8">
                            <h3 className="text-2xl font-bold dark:text-white text-gray-900 mb-4">Interesse an unseren Events?</h3>
                            <p className="dark:text-gray-300 text-gray-600 mb-6 max-w-2xl mx-auto">
                                Melde dich bei uns, um über kommende Veranstaltungen informiert zu werden und keine spannenden Workshops oder Hackathons zu
                                verpassen.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                ...
                                <Button variant="secondary" className="dark:hover:bg-slate-600 dark:hover:text-gray-50 dark:text-gray-100 dark:bg-slate-700">
            ...
            >
                <div className="container mx-auto max-w-6xl">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold dark:text-white text-gray-900 mb-4">Unsere Projekte</h2>
                        <p className="dark:text-gray-300 text-gray-600">Entdecke einige unserer aktuellen Open Source Projekte</p>
                    </div>

                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {projects.map((project, index) => (
                            <Project key={index} name={project.name} description={project.description} tech={project.tech} />
                        ))}
                    </div>
                </div>
            </section>
            ...
            {/* Team Section */}
            <section id="team" className="py-16 px-4 dark:bg-gradient-to-br dark:from-slate-800 dark:to-slate-700 bg-gradient-to-br from-gray-50 to-slate-100">
                <div className="container mx-auto max-w-6xl">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold dark:text-white text-gray-900 mb-4">Unser Team</h2>
                        <p className="dark:text-gray-300 text-gray-600">Lerne die Menschen kennen, die unsere Open Source Projekte vorantreiben</p>
                    </div>

                    {/* Core Team */}
                    <div className="mb-16">
                        <h3 className="text-2xl font-semibold dark:text-white text-gray-900 mb-8 text-center">Core Team</h3>
                    ...
                    {/* Members */}
                    <div>
                        <h3 className="text-2xl font-semibold dark:text-white text-gray-900 mb-8 text-center">Aktive Mitglieder</h3>
                        <div
                        ...
                        >
                            {members
                                .filter((m) => !m.leads_project)
                                .map((member, index) => (
                                    <Member key={index} avatar={member.avatar} name={member.name} role={member.role} />
                                ))}
                        </div>
                    </div>
                    ...
                    <div className="mt-16 text-center">
                        <div className="bg-gradient-to-r dark:from-blue-900 dark:to-indigo-900 from-blue-50 to-indigo-50 rounded-2xl p-8">
                            <h3 className="text-2xl font-bold dark:text-white text-gray-900 mb-4">Werde Teil unseres Teams!</h3>
                            <p className="dark:text-gray-300 text-gray-600 mb-6 max-w-2xl mx-auto">
                                Wir suchen immer nach motivierten Entwicklern, Designern und Open Source Enthusiasten. Egal ob Anfänger oder Experte - bei uns
                                findest du spannende Projekte und ein tolles Team.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <Button className="bg-gradient-to-r dark:from-blue-600 dark:to-blue-700 dark:hover:from-blue-700 dark:hover:to-blue-800 from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700">
                    ...
                    <div className="mt-16">
                        <div className="text-center mb-8">
                            <h3 className="text-2xl font-bold dark:text-white text-gray-900 mb-4">Einblicke in unser Team</h3>
                            <p className="dark:text-gray-300 text-gray-600">Von Hackathons bis Server-Aufbau - hier siehst du, was wir gemeinsam erleben</p>
                        </div>
            ...
            {/* CTA Section */}
            <section id="cta" className="py-20 px-4 bg-gradient-to-r dark:from-blue-800 dark:to-blue-900 from-blue-500 to-blue-600">
                <div className="container mx-auto text-center max-w-4xl">
                    <h2 className="text-4xl font-bold text-white mb-6">Lust mitzumachen?</h2>
                    <p className="text-xl dark:text-blue-100 text-blue-100 mb-8 leading-relaxed">
                        Wenn du Lust hast, bei uns mitzumachen, dann schau doch mal bei einem unserer Treffen vorbei. Wende dich dafür einfach an uns - wir
                        freuen uns auf dich!
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button size="lg" variant="secondary" className="bg-white dark:text-blue-800 text-blue-600 hover:bg-gray-100">
                            <Mail className="w-5 h-5 mr-2" />
                            app (at) tum.de
                        </Button>
                        <Button size="lg" variant="outline" className="border-white text-slate-900 hover:bg-white/10">
                            <Users className="w-5 h-5 mr-2" />
                            Zu unseren Treffen
                        </Button>
                    </div>
