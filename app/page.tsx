...
import { Calendar, CalendarIcon, Code, Github, Lightbulb, Mail, MapPin, Users, Users2 } from "lucide-react";
...
export default function HomePage() {
    ...
    const projects: readonly ProjectProps[] = [
        ...
        {
            description: "open-source live-streaming stack for recording and streaming lectures",
    ...
    return (
        <div>
            <section className="py-20 px-4">
                <div className="container mx-auto text-center max-w-4xl">
                    <Link href="https://www.sv.tum.de/sv/hochschulgruppen/">
                        <Badge className="mb-6 px-4 py-2 dark:bg-slate-700 dark:text-gray-300 dark:hover:text-gray-900" variant="secondary">
                    ...
                    <div className="mt-12 text-center">
                        <div className="bg-gradient-to-r dark:from-blue-900 dark:to-indigo-900 from-blue-50 to-indigo-50 rounded-2xl p-8">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                ...
                                <Button className="dark:hover:bg-slate-600 dark:hover:text-gray-50 dark:text-gray-100 dark:bg-slate-700" variant="secondary">
                ...
                <div className="container mx-auto max-w-6xl">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {projects.map((project) => (
                            <Project description={project.description} key={project.name} link={project.link} name={project.name} tech={project.tech} />
                        ))}
                    </div>
                </div>
            </section>
            ...
            {/* Team Section */}
            <section className="py-16 px-4 dark:bg-gradient-to-br dark:from-slate-800 dark:to-slate-700 bg-gradient-to-br from-gray-50 to-slate-100" id="team">
                <div className="container mx-auto max-w-6xl">
                    <div className="text-center mb-12">
                    ...
                    <div>
                        ...
                        >
                            {members
                                .filter((m) => !m.leads_project)
                                .map((member) => (
                                    <Member avatar={member.avatar} key={member.name + member.avatar} name={member.name} role={member.role} />
                                ))}
                        </div>
                    </div>
                    {/* Join Team CTA */}
            ...
            {/* CTA Section */}
            <section className="py-20 px-4 bg-gradient-to-r dark:from-blue-800 dark:to-blue-900 from-blue-500 to-blue-600" id="cta">
                <div className="container mx-auto text-center max-w-4xl">
                    ...
                    <p className="text-xl dark:text-blue-100 text-blue-100 mb-8 leading-relaxed">
                        Wenn du Lust hast, bei uns mitzumachen, dann schau doch mal bei einem unserer Treffen vorbei. <br />
                        Wende dich dafür einfach an uns - wir freuen uns auf dich!
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button className="bg-white dark:text-blue-800 text-blue-600 hover:bg-gray-100" size="lg" variant="secondary">
                            <Mail className="w-5 h-5 mr-2" />
                            app (at) tum.de
                        </Button>
                        <Button className="border-white text-slate-900 dark:text-slate-50 hover:bg-white/10" size="lg" variant="outline">
                            <Users className="w-5 h-5 mr-2" />
                            Zu unseren Treffen
                        </Button>
                    </div>
