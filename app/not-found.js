...
export default function Custom404() {
  return <div className="container mx-auto text-center max-w-4xl flex items-center flex-col grow gap-4  mb-20">
    <Image
      priority 
      src={NotFoundIcon}
      alt="grafik einer 404 vor dem Hauptgebäude der TUM"
    />
