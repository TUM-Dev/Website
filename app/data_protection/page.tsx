...
import { Shield, User, Database, AlertCircle, FileText, Settings } from "lucide-react";
            ...
            <section className="py-20 px-4">
                <div className="container mx-auto text-center max-w-4xl">
                    ...
                    <p className="text-xl dark:text-gray-300 text-gray-600 mb-8 leading-relaxed max-w-3xl mx-auto">
                        Erfahren Sie, wie wir Ihre persönlichen Daten erfassen, verwenden und schützen. Transparenz und Datenschutz haben für uns höchste
                        Priorität.
                    </p>
                </div>
            </section>
            ...
            <div className="dark:bg-slate-800 bg-white py-16 px-4">
                <div className="max-w-4xl mx-auto">
                    <div className="space-y-12">
                        ...
                        <section id="verantwortlicher" className="bg-blue-50 p-6 rounded-lg">
                            ...
                            <div className="ml-11 space-y-3">
                                <p className="text-gray-700">Verantwortlich für die Datenverarbeitung im Sinne der Datenschutz-Grundverordnung (DSGVO) ist:</p>
                                <div className="bg-white p-4 rounded-lg border-l-4 border-blue-600">
                                    <address className="text-gray-700 not-italic">
                                        <div className="space-y-1">
                                            <p className="font-semibold text-blue-800">OpenSource @ TUM e.V.</p>
                                            <p>
                                                <span className="font-medium">E-Mail:</span> app at tum dot de
                                            </p>
                                            <p>
                                                <span className="font-medium">Hosting:</span> Die Server werden vom <strong>Leibniz-Rechenzentrum (LRZ)</strong>{" "}
                        ...
                        <section id="daten" className="bg-green-50 p-6 rounded-lg">
                            ...
                            <div className="ml-11 space-y-8">
                                <article className="bg-white p-6 rounded-lg border-l-4 border-green-600">
                                    <h3 className="text-xl font-semibold text-green-800 mb-4">a) Technische Basisinformationen</h3>
                                    <div className="space-y-4">
                                        <p className="text-gray-700">
                                            Beim Start und während der Nutzung der App werden folgende technische Informationen erhoben:
                                        </p>
                                        ...
                                        <p className="text-gray-700">
                                            Diese Daten dienen ausschließlich zur Sicherstellung des technischen Betriebs, zur Fehleranalyse und zur
                                            ...
                                            <div className="flex">
                                                ...
                                                <div>
                                                    <p className="text-sm text-yellow-800">
                                                        <strong>Hinweis:</strong> Auch Google (als Betreiber des Play Store) kann unabhängig von uns Daten im
                                                        Rahmen der App-Installation und -Nutzung erheben. Bitte beachten Sie hierzu die{" "}
                                                        <a
                                ...
                                <article className="bg-white p-6 rounded-lg border-l-4 border-green-600">
                                    <h3 className="text-xl font-semibold text-green-800 mb-4">b) Anonyme Nutzungsdaten</h3>
                                    <p className="text-gray-700">
                                        Zur Optimierung der App erfassen wir anonymisierte Informationen über die Nutzung einzelner Funktionen. Beispielsweise
                                        wird registriert, wie häufig bestimmte Bereiche oder Schnittstellen der App verwendet werden. Eine Identifizierung
                                        einzelner Nutzer ist dabei nicht möglich.
                                    </p>
                                </article>

                                <article className="bg-white p-6 rounded-lg border-l-4 border-green-600">
                                    <h3 className="text-xl font-semibold text-green-800 mb-4">c) Fehler- und Absturzberichte (Firebase Crashlytics)</h3>
                                    <div className="space-y-4">
                                        <p className="text-gray-700">
                                        ...
                                        <div className="bg-gray-50 p-3 rounded border">
                                            <address className="text-gray-700 not-italic text-sm">
                                                <div className="space-y-1">
                                                    ...
                                                    <p>Google Building Gordon House, Barrow Street, Dublin 4, Irland</p>
                                                </div>
                                            </address>
                                        </div>
                                        <p className="text-gray-700">Im Falle eines Absturzes werden folgende anonymisierte Daten an Firebase übermittelt:</p>
                                        <ul className="list-disc list-inside space-y-2 ml-4 text-gray-700">
                                        ...
                                        <p className="text-gray-700">
                                            Es werden <strong>keine personenbezogenen Daten</strong> an Google übermittelt. Weitere Informationen zur
                                        ...
                                        <p className="text-gray-700">
                                            Rechtsgrundlage der Datenverarbeitung ist Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an der Fehleranalyse
                        ...
                        <section id="personenbezogene-daten" className="bg-purple-50 p-6 rounded-lg">
                            ...
                            <div className="ml-11 space-y-4">
                                <p className="text-gray-700">
                                    Bei Login über TUMonline mittels eines autorisierten Tokens erheben und verarbeiten wir die folgenden personenbezogenen
                                ...
                                <div className="bg-white p-4 rounded-lg border-l-4 border-purple-600">
                                    <p className="text-gray-700">
                                        Es werden <strong>keine weiteren personenbezogenen Daten</strong> (z. B. Vorlesungen, Noten, Studienbeitragsstatus) auf
                                        unseren Servern gespeichert. Alle studienbezogenen Informationen werden{" "}
                                        <strong>ausschließlich direkt von TUMonline</strong> abgerufen und verbleiben auf dem Gerät. Der Zugriff erfolgt nur,
                                        wenn Sie vorher die entsprechende Berechtigung erteilt haben.
                                    </p>
                                </div>
                            </div>
                        </section>
                        ...
                        {/* Rechte Section */}
                        <section id="rechte" className="bg-orange-50 p-6 rounded-lg">
                            ...
                            <div className="ml-11 space-y-4">
                                <p className="text-gray-700">Als betroffene Person haben Sie folgende Rechte gemäß Art. 15 ff. DSGVO:</p>
                                <ul className="list-disc list-inside space-y-2 ml-4 text-gray-700">
                        ...
                        {/* Änderungen Section */}
                        <section id="aenderungen" className="bg-indigo-50 p-6 rounded-lg">
                            ...
                            <p className="ml-11">Wir behalten uns vor, diese Datenschutzerklärung bei Bedarf zu aktualisieren.</p>
                        </section>
                    </div>
                </div>
            </div>
