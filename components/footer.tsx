import { Code, ExternalLink, Github, Mail, MapPin, ShieldCheck } from "lucide-react";
            ...
            <div className="container mx-auto max-w-6xl">
                <div className="grid md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <Link className="dark:text-gray-500 text-gray-400" href="https://www.sv.tum.de/sv/hochschulgruppen/">
