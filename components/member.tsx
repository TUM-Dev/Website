...
export const Member: React.FC<MemberProps> = ({ name, avatar, role, leads_project, github, linkedin }) => {
    if (leads_project) {
        return (
            <Card className="dark:bg-slate-700 dark:border-slate-600 bg-white border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm font-medium dark:text-blue-400 text-blue-600 mb-1">{role}</p>
